...
import edu.upc.eetac.dsa.talk.dao.AuthTokenDAOImpl;
import edu.upc.eetac.dsa.talk.dao.UserAlreadyExistsException;
import edu.upc.eetac.dsa.talk.dao.UserDAO;
import edu.upc.eetac.dsa.talk.dao.UserDAOImpl;
import edu.upc.eetac.dsa.talk.entity.AuthToken;
import edu.upc.eetac.dsa.talk.entity.User;
...
public class UserResource {
    ...
    @Produces(TalkMediaType.TALK_AUTH_TOKEN)
    public Response registerUser(@FormParam("loginid") String loginid, @FormParam("password") String password, @FormParam("email") String email, @FormParam("fullname") String fullname, @Context UriInfo uriInfo) throws URISyntaxException {
        ...
        return Response.created(uri).type(TalkMediaType.TALK_AUTH_TOKEN).entity(authenticationToken).build();
    }

    @Path("/{id}")
    @GET
    @Produces(TalkMediaType.TALK_USER)
    ...
    @Path("/{id}")
    @PUT
    @Consumes(TalkMediaType.TALK_USER)
    @Produces(TalkMediaType.TALK_USER)
