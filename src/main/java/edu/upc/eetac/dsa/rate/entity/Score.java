...
public class Score {
    @InjectLinks({
            ...
            @InjectLink(resource = UserResource.class, method = "getScore", style = InjectLink.Style.ABSOLUTE, rel = "user-profile", title = "User profile", bindings = @Binding(name = "id", value = "${instance.userid}")),
    })
