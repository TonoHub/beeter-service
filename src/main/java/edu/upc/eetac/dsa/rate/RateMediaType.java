 ...
 */
public interface RateMediaType {
    public final static String RATE_AUTH_TOKEN = "application/vnd.dsa.rate.auth-token+json";
    public final static String RATE_USER = "application/vnd.dsa.rate.user+json";
    public final static String RATE_REV = "application/vnd.dsa.rate.rev+json";
